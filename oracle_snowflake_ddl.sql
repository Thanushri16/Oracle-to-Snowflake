...
ALTER TABLE feedback_status_config ADD CONSTRAINT uni_client UNIQUE (client_id);
ALTER TABLE ipl_match_players ADD CONSTRAINT uni_tab2 UNIQUE (create_user_id,player_name);
